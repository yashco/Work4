...
@interface LeftMenuViewController ()<UITableViewDataSource, UITableViewDelegate,Social>
{
...
- (void)viewDidLoad {
    ...
    listArray = [NSMutableArray arrayWithObjects:@"Home Screen", @"Listings Overview", @"Notifications", @"Add a job", @"Account", @"About", @"Settings", @"Support", @"Feedback", nil];
